...
Liquidity mining is that market. Because there is no direct incentive to bridge demand for liquidity with supply on traditional AMMs, a boom in liquidity mining has taken off which is a strong indicator that most token markets are under-liquid. In support of the stablecoin over provision hypothesis, it should be noted that most farms, in addition to their own protocol tokens offer incentives for pairing their token with stablecoins in an effort to draw in the abundant liquidity found in stablecoin pools.
